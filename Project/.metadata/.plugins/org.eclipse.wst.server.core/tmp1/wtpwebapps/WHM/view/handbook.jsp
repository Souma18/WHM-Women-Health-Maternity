...
<body>
	...
	<div class="main">
		<div class="container">
			<div class="row">
				<!-- Cột bên trái -->
				<div class="main-left-col col-lg-10 col-md-7 col-sm-12">
					<div
						class="main-left-cards row row-cols-lg-3 row-cols-md-2 row-cols-1 g-4">
						<!-- cart -->
						<div class="card"
							onclick="window.location.href='../listCamNang/cart1.html'"
							style="cursor: pointer">
							<img src="../img/hon-nhau-co-lay-sui-mao-ga-khong-1.jpg"
								class="card-img-top" alt="..." />
							<div class="card-body">
								<h5 class="card-title">Hôn nhau có gây xùi mào gà không?
									Bốn cách phòng bệnh</h5>
								<p class="card-text">Nhiều cặp đôi thắc mắc là khi hôn nhau
									có lây sùi mào gà không? Hôn nhau được xem là một cách truyền
									tải tình cảm, mang đến cảm giác hưng phân cho các cặp đôi. Vậy
									khi có lây sùi mào gà không? Bệnh sùi mào gà có lây qua đường
									miệng không? Hãy theo dõi bài viết sau đây để giải đáp các thắc
									mắc trên.</p>
								<small class="viewer"> <span>10/10/2024</span>
									<div>
										<svg width="15" height="11" viewBox="0 0 15 11" fill="none"
											class="icon-color" xmlns="http://www.w3.org/2000/svg">
                        <path
				...
				<!-- Cột bên phải -->
				<div class="main-right col-xl-2 col-lg-4 col-md-5 col-sm-12">
					<div class="main-right-list">
						<div class="d-flex main-right-title">
							<h6 class="text-red">Chuyên khoa</h6>
						</div>

						<div class="list-a">
							<ul class="list-group">
								<li class="list-group-item"><a href="#">Nhi</a></li>
								<li class="list-group-item"><a href="#">Phụ sản</a></li>
								<li class="list-group-item"><a href="#">Da liễu</a></li>
								<li class="list-group-item"><a href="#">Tâm Lý</a></li>
							</ul>
						</div>
					</div>
				</div>
