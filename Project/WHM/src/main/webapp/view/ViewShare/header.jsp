			...
			<div class="container">
				<div class="row w-100 align-items-center">
					<div class="col-lg-3 col-md-4 col-sm-6">
						<a class="navbar-brand text-pink" href="../TrangChu/index.html">
							...
							<ul class="navbar-nav ms-auto">
								...
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu" aria-labelledby="bookingDropdown">
										<li><a class="dropdown-item" href="../BacSi/bacsi.html">Bác
												sĩ</a></li>
										<li><a class="dropdown-item"
											href="../CoSoYTe/coSoYTe.html">Cơ sở y tế</a></li>
									</ul></li>
								<li class="nav-item"><a class="nav-link"
									href="../HoiDapBacSi/hoidap.html">Hỏi đáp bác sĩ</a></li>
								<li class="nav-item"><a class="nav-link"
									href="../HoSoSucKhoe/hoSoSucKhoe.html">Hồ sơ sức khỏe</a></li>
								<li class="nav-item"><a class="nav-link"
									href="../CamNang/camnang.html">Cẩm nang</a></li>
							</ul>
						</div>
					</div>
				</div>
